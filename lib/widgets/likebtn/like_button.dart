import 'package:fishreduxwanandroid/widgets/likebtn/dot_painter.dart';
...
class _LikeButtonState extends State<LikeButton> with TickerProviderStateMixin {
  ...
  void _initAllAnimations() {
    outerCircle = Tween<double>(begin: 0.1, end: 1.0).animate(CurvedAnimation(
        parent: _controller,
        curve: Interval(
          0.0,
          0.3,
    ...
    innerCircle = Tween<double>(begin: 0.2, end: 1.0).animate(CurvedAnimation(
        parent: _controller,
        curve: Interval(
          0.2,
          0.5,
